...
public class PayGate {
    ...
    /*public static String getURL_PayCompBoost(String payGate) {
        if (Constants.pg_paydollar.equalsIgnoreCase(payGate)) {
            URLpayment = Constants.url_paydollar_payCompBoost;
        } else if (Constants.pg_pesopay.equalsIgnoreCase(payGate)) {
            URLpayment = Constants.url_paydollar_payCompBoost;
        } else if (Constants.pg_siampay.equalsIgnoreCase(payGate)) {
            URLpayment = Constants.url_paydollar_payCompBoost;
    ...
    /*public static String getURL_orderApiBOOST(String payGate) {
        if (Constants.pg_paydollar.equalsIgnoreCase(payGate)) {
            URLorder = Constants.url_paydollar_orderApiBOOST;
        } else if (Constants.pg_pesopay.equalsIgnoreCase(payGate)) {
            URLorder = Constants.url_paydollar_orderApiBOOST;
        } else if (Constants.pg_siampay.equalsIgnoreCase(payGate)) {
            URLorder = Constants.url_paydollar_orderApiBOOST;
