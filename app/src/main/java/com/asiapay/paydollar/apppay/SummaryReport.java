...
public class SummaryReport extends AppCompatActivity {
    ...
    */
    ...
    protected void onCreate(Bundle savedInstanceState) {
        System.out.println("+++ Enter SummaryReport +++");
        ...
        print_button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                label_total_refund_trx = getString(R.string.total_refund_trx_label);
                label_total_refund_amnt = getString(R.string.total_refund_amnt_label);
                label_total_request_refund_trx = getString(R.string.total_request_refund_trx_label);
                label_total_request_refund_amnt = getString(R.string.total_request_refund_amnt_label);
                label_total_void_trx = getString(R.string.total_void_trx_label);
                label_total_void_amnt = getString(R.string.total_void_amnt_label);
