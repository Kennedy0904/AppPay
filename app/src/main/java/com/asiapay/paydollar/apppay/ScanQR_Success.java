...
public class ScanQR_Success extends AppCompatActivity {
    ...
    public void printAlipayTHReceipt(String receiptType) {
        ...
        //一个中文2个字节 一个英文/一个空格/一个标点符号1个字节
        // 简体繁体中文一行16个 空格一行32个 英文大小写一行32个 一个感叹号或逗号
        product_tid = info_tid;
        product_merid = merchantId;
        product_batchno = "12345678";
        product_traceno = "12345678";
        product_host = "WALLET";
        product_stan = "0005";
        product_walletcard = "2400124584783668";
        product_transactionDate = txnDate;
        product_time = txnTime;
        product_apprcode = "602956";
        product_refNo = "200000008859";
        product_CurrCode = "THB";
        product_amount = "1.00";
        product_PayMethod = getString(R.string.print_alipaysale);
